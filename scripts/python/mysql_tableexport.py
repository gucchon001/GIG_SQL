...
from core.config.my_logging import setup_department_logger  # ログ設定用
from src.utils import slack_notify  # Slack通知用

LOGGER = setup_department_logger('googlesheet_export', app_type='datasets')  # ロガーの設定
...
# 認証情報の取得（secrets.envから統一）
import os
from dotenv import load_dotenv
load_dotenv('config/secrets.env')
json_keyfile_path = os.getenv('JSON_KEYFILE_PATH') or config.get('Credentials', {}).get('json_keyfile_path', '')
