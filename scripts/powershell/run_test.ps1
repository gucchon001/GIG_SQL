...
try {
    ...
    # Execute the moved main_test.py script
    $TestScript = Join-Path $ProjectRoot "scripts\python\main_test.py"
    Write-Host "Executing script: $TestScript" -ForegroundColor Cyan
    python $TestScript
