...
def main(sheet_name, execution_column, config_file):
    ...
    # ログ動作確認用メッセージ
    print("=" * 120)
    print("common_exe_functions.py: main関数開始")
    print(f"引数 - sheet_name: '{sheet_name}'")
    print(f"引数 - execution_column: '{execution_column}'")
    print(f"引数 - config_file: '{config_file}'")
    print("=" * 120)
    
    LOGGER.info("=" * 120)
    LOGGER.info("common_exe_functions.py: main関数開始")
    LOGGER.info("プロセス開始")
    LOGGER.info(f"引数 - sheet_name: '{sheet_name}'")
    LOGGER.info(f"引数 - execution_column: '{execution_column}'")
    LOGGER.info(f"引数 - config_file: '{config_file}'")
    LOGGER.info("=" * 120)
